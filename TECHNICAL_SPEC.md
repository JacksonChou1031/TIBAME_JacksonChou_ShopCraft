...
- Docker Compose 啟動 SQL Server 2022（固定使用 `2022-CU26-ubuntu-22.04` image），容器內使用 1433、主機對外使用 1435（避開本機 SQL Server port）；Spring Boot 連線使用專用 ecommerce_app 帳號，SA 僅用於初始化。
